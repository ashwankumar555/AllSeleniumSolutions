...
public class WebTableFixedHeader {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement elementtoappear = new WebDriverWait(driver, Duration.ofSeconds(5))
	    .until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".tableFixHead")));
